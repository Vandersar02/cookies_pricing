...
👉 **[Guide de déploiement sur Vercel](./DEPLOIEMENT_VERCEL.md)** (complet)  
👉 **[Référence rapide Vercel](./REFERENCE_RAPIDE_VERCEL.md)** (5 minutes)  
👉 **[Résumé de configuration](./RESUME_CONFIGURATION_VERCEL.md)** (explications)
